...
public class softwarelist
{
	...
	extern extern void osd_change_directory(const char *);
	...
	extern unsigned int ZEXPORT crc32 (unsigned int crc, const UBytePtr buf, unsigned int len);
	...
	static UINT32 CalculateCrc(const char *file, UINT32 (*partialcrc)(const UBytePtr buf, unsigned int size))
	{
		UINT32 crc = 0;
		int length;
		UBytePtr data = NULL;
