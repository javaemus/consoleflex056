...
public class serial
{
	...
	/* load image */
	int serial_device_load(int type, int id, UBytePtr *ptr, int *pDataSize)
	{
		void *file;
	...
	/* initialise stream */
	static void data_stream_init(struct data_stream *stream, UBytePtr pData, unsigned long DataLength)
	{
		stream.pData = pData;
