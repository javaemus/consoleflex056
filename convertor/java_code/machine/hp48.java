...
public class hp48
{
	...
	int hp48_in(void)
	{
		...
		if ((out & 0x10) != 0) {
			if (KEY_ON != 0) data|=0x20;
			if (KEY_ENTER != 0) data|=0x10;
			if (KEY_Y != 0) data|=8;
			if (KEY_Z != 0) data|=4;
			if (KEY_DEL != 0) data|=2;
			if (KEY_LEFT != 0) data|=1;
		}
		if ((out & 8) != 0) {
			if (KEY_ALPHA != 0) data|=0x20;
			if (KEY_S != 0) data|=0x10;
			if (KEY_7 != 0) data|=8;
			if (KEY_8 != 0) data|=4;
			if (KEY_9 != 0) data|=2;
			if (KEY_DIVIDE != 0) data|=1;
		}
		if ((out & 4) != 0) {
			if (KEY_ORANGE != 0) data|=0x20;
			if (KEY_G != 0) data|=0x10;
			if (KEY_4 != 0) data|=8;
			if (KEY_5 != 0) data|=4;
			if (KEY_6 != 0) data|=2;
			if (KEY_MULTIPLY != 0) data|=1;
		}
		if ((out & 2) != 0) {
			if (KEY_BLUE != 0) data|=0x20;
			if (KEY_A != 0) data|=0x10;
			if (KEY_1 != 0) data|=8;
			if (KEY_2 != 0) data|=4;
			if (KEY_3 != 0) data|=2;
	...
	#else
		if ((out & 0x100) != 0) data|=input_port_0_r(0);
		if ((out & 0x080) != 0) data|=input_port_1_r(0);
		if ((out & 0x040) != 0) data|=input_port_2_r(0);
		if ((out & 0x020) != 0) data|=input_port_3_r(0);
		if ((out & 0x010) != 0) data|=input_port_4_r(0);
		if ((out & 0x008) != 0) data|=input_port_5_r(0);
		if ((out & 0x004) != 0) data|=input_port_6_r(0);
		if ((out & 0x002) != 0) data|=input_port_7_r(0);
		if ((out & 0x001) != 0) data|=input_port_8_r(0);
	#endif
		return data;
	}
	
	
	public static InitDriverPtr init_hp48s = new InitDriverPtr() { public void handler() 
	{
		int i,j,t;
	...
	public static InitDriverPtr init_hp48g = new InitDriverPtr() { public void handler() 
	{
		int i,j,t;
		UINT8 *mem=memory_region(REGION_CPU1);
	...
	public static InitMachinePtr hp48_machine_init = new InitMachinePtr() { public void handler() 
	{
		hp48_mem_reset();
	} };
