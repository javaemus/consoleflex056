...
public class intv
{
	...
	public static InitDriverPtr init_intv = new InitDriverPtr() { public void handler() 
	{
	} };
	
	public static InitMachinePtr intv_machine_init = new InitMachinePtr() { public void handler() 
	{
	...
	public static InterruptPtr intv_interrupt = new InterruptPtr() { public int handler() 
	{
	...
	public static ReadHandlerPtr intv_right_control_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		for(byte=0; byte<3; byte++)
		{
			...
			{
				case 0:
					value = input_port_0_r.handler(0);
					break;
				case 1:
					value = input_port_1_r.handler(0);
					break;
				case 2:
					value = input_port_2_r.handler(0);
					break;
			}
			for(bit=7; bit>=0; bit--)
			{
	...
	public static InitDriverPtr init_intvkbd = new InitDriverPtr() { public void handler() 
	{
	} };
