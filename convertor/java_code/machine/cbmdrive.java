...
public class cbmdrive
{
	...
	static int cbm_compareNames (UBytePtr left, UBytePtr right)
	{
		int i;
	...
	static int d64_find (CBM_Drive * drive, UBytePtr name)
	{
	...
	static int c1551_d64_command (CBM_Drive * c1551, UBytePtr name)
	{
		int pos;
	...
	static int c1551_fs_command (CBM_Drive * c1551, UBytePtr name)
	{
		FILE *fp;
		int type=0;
		int read;
