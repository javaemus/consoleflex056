...
public class sym1
{
	...
	*/
	...
	public static InitDriverPtr init_sym1 = new InitDriverPtr() { public void handler() 
	{
		via_config(0, &via0);
		via_config(1, &via1);
		via_config(2, &via2);
	...
	public static InitMachinePtr sym1_init_machine = new InitMachinePtr() { public void handler() 
	{
		via_reset();
		riot_reset(0);
	} };
	...
	public static InterruptPtr sym1_interrupt = new InterruptPtr() { public int handler() 
	{
		int i;
