...
public class pc8801
{
	...
	static UBytePtr mainROM;
	UBytePtr pc8801_mainRAM=NULL;
	...
	public static InterruptPtr pc8801_interrupt = new InterruptPtr() { public int handler() 
	{
	...
	public static WriteHandlerPtr pc8801_writemem1 = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	  pc8801_mainRAM[offset]=data;
	} };
	
	public static WriteHandlerPtr pc8801_writemem2 = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	  pc8801_mainRAM[offset+0x6000]=data;
	} };
	
	public static ReadHandlerPtr pc8801_read_textwindow  = new ReadHandlerPtr() { public int handler(int offset)
	{
	  return pc8801_mainRAM[(offset+text_window*0x100)&0xffff];
	} };
	
	public static WriteHandlerPtr pc8801_write_textwindow = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	{
	  if (is_Nbasic != 0) is_V2mode=0;
	  if (is_V2mode != 0) pc88sr_is_highspeed=1;
