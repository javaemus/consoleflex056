...
public class svi318
{
	...
	*/
	public static ReadHandlerPtr svi318_ppi_port_a_r  = new ReadHandlerPtr() { public int handler(int offset)
		{
	    int data = 0x0f;
	...
	*/
	public static ReadHandlerPtr svi318_ppi_port_b_r  = new ReadHandlerPtr() { public int handler(int offset)
		{
		int row;
	...
	*/
	public static WriteHandlerPtr svi318_ppi_port_c_w = new WriteHandlerPtr() {public void handler(int offset, int data)
		{
	...
	*/
	...
	public static timer_callback svi_fdc_callback = new timer_callback() { public void handler(int param) 
		{
	    switch( param )
	    	{
	        case WD179X_IRQ_CLR:
	...
	//        wd179x_stop_drive();
	    ...
	    if ((data & 2) != 0) seldrive=1;
	
	    if ((data & 1) != 0) seldrive=0;
	...
	*/
	...
	public static InitDriverPtr init_svi318 = new InitDriverPtr() { public void handler() 
		{
		int i,n;
