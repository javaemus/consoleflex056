...
public class coupe
{
	...
	public static InitMachinePtr coupe_init_machine_common = new InitMachinePtr() { public void handler() 
	{
		memory_set_bankhandler_r(1, 0, MRA_BANK1);
		memory_set_bankhandler_w(1, 0, MWA_BANK1);
	    memory_set_bankhandler_r(2, 0, MRA_BANK2);
	...
	public static InitMachinePtr coupe_init_machine_256 = new InitMachinePtr() { public void handler() 
	{
		PAGE_MASK = 0x0f;
		RAM_SIZE = 0x40000;
	...
	public static InitMachinePtr coupe_init_machine_512 = new InitMachinePtr() { public void handler() 
	{
		PAGE_MASK = 0x1f;
		RAM_SIZE = 0x80000;
		coupe_init_machine_common();
