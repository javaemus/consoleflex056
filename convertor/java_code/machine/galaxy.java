...
public class galaxy
{
	...
	public static InitMachinePtr galaxy_init_machine = new InitMachinePtr() { public void handler() 
	{
	...
	static void galaxy_setup_gal(UBytePtr data, unsigned long data_size)
	{
		int i;
		unsigned char lo,hi;
