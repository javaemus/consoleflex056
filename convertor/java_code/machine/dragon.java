...
public class dragon
{
	...
	***************************************************************************/
	...
	public static ReadHandlerPtr d_pia0_cb1_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		return m6847_fs_r(0);
	} };
	...
	public static WriteHandlerPtr d_pia0_pa_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		if (joystick_mode() == JOYSTICKMODE_HIRES_CC3MAX) {
	...
	***************************************************************************/
	...
	public static ReadHandlerPtr d_pia1_pb_r_dragon  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr d_pia1_pb_r_coco2  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	***************************************************************************/
	...
	public static InitMachinePtr coco2_init_machine = new InitMachinePtr() { public void handler() 
	{
		coco_rom = memory_region(REGION_CPU1) + 0x10000;
