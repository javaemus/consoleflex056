...
public class kc
{
	...
	*/
	...
	/* load image */
	int kc_load(int type, int id, UBytePtr *ptr)
	{
		void *file;
	...
	*/
	...
	static UBytePtr kc85_module_rom;
	...
	*/
	...
	public static InitMachinePtr kc85_4d_init_machine = new InitMachinePtr() { public void handler() 
	{
		kc85_4_init_machine();
	...
	public static InitMachinePtr kc85_3_init_machine = new InitMachinePtr() { public void handler() 
	{
		kc85_ram = malloc(64*1024);
		kc85_pio_data[0] = 0x0f;
		kc85_pio_data[1] = 0x0f1;
