...
public class bbc
{
	...
	******************************************************************************/
	...
	{
	  //if (errorlog != 0) fprintf(errorlog, "via_system_write_ca2: $%02X\n", data);
	} };
	...
	{
	  //if (errorlog != 0) fprintf(errorlog, "via_system_write_cb2: $%02X\n", data);
	} };
	...
	***************************************/
	...
	public static InitMachinePtr init_machine_bbcb1770 = new InitMachinePtr() { public void handler() 
	{
		cpu_setbank(2,memory_region(REGION_USER1)+0x40000);  /* bank 2 points at the OS rom  from c000 to ffff */
		cpu_setbank(3,memory_region(REGION_USER1));          /* bank 3 is the paged ROMs     from 8000 to bfff */
	...
	public static InitMachinePtr init_machine_bbcbp = new InitMachinePtr() { public void handler() 
	{
	...
	public static InitMachinePtr init_machine_bbcb6502 = new InitMachinePtr() { public void handler() 
	{
		cpu_setbank(2,memory_region(REGION_USER1)+0x40000);  /* bank 2 points at the OS rom  from c000 to ffff */
		cpu_setbank(3,memory_region(REGION_USER1));          /* bank 3 is the paged ROMs     from 8000 to bfff */
