...
public class sh2H
{
	...
	extern extern void sh2_reset (void *param);		  /* Reset registers to the initial values */
	extern extern int	sh2_execute(int cycles);		  /* Execute cycles - returns number of cycles actually run */
