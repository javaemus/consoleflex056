...
#define AT_KEYBOARD \
	...
	PORT_BITX( 0x0080, IP_ACTIVE_HIGH, IPT_KEYBOARD,	"(MF2);11",		KEYCODE_F11,        IP_JOY_NONE ) /* F11                         57  D7 */\
	PORT_BITX( 0x0100, IP_ACTIVE_HIGH, IPT_KEYBOARD,	"(MF2);12",		KEYCODE_F12,        IP_JOY_NONE ) /* F12                         58  D8 */\
	PORT_BIT ( 0xfe00, 0x0000, IPT_UNUSED );
		\
	PORT_START(); 	/* IN10 */\
	PORT_BITX( 0x0001, IP_ACTIVE_HIGH, IPT_KEYBOARD,	"(MF2);P Enter",		KEYCODE_ENTER_PAD,  IP_JOY_NONE ) /* PAD Enter                   60  e0 */\
	PORT_BITX( 0x0002, IP_ACTIVE_HIGH, IPT_KEYBOARD,	"(MF2);ight Control",	KEYCODE_RCONTROL,   IP_JOY_NONE ) /* Right Control               61  e1 */\
	PORT_BITX( 0x0004, IP_ACTIVE_HIGH, IPT_KEYBOARD,	"(MF2);P /",			KEYCODE_SLASH_PAD,  IP_JOY_NONE ) /* PAD Slash                   62  e2 */\
	PORT_BITX( 0x0008, IP_ACTIVE_HIGH, IPT_KEYBOARD,	"(MF2);RTSCR",			KEYCODE_PRTSCR,     IP_JOY_NONE ) /* Print Screen                63  e3 */\
	PORT_BITX( 0x0010, IP_ACTIVE_HIGH, IPT_KEYBOARD,	"(MF2);LTGR",			KEYCODE_RALT,       IP_JOY_NONE ) /* ALTGR                       64  e4 */\
	PORT_BITX( 0x0020, IP_ACTIVE_HIGH, IPT_KEYBOARD,	"(MF2);ome",			KEYCODE_HOME,       IP_JOY_NONE ) /* Home                        66  e6 */\
	PORT_BITX( 0x0040, IP_ACTIVE_HIGH, IPT_KEYBOARD,	"(MF2);ursor Up",		KEYCODE_UP,         IP_JOY_NONE ) /* Up                          67  e7 */\
	PORT_BITX( 0x0080, IP_ACTIVE_HIGH, IPT_KEYBOARD,	"(MF2);age Up",			KEYCODE_PGUP,       IP_JOY_NONE ) /* Page Up                     68  e8 */\
	PORT_BITX( 0x0100, IP_ACTIVE_HIGH, IPT_KEYBOARD,	"(MF2);ursor Left",		KEYCODE_LEFT,       IP_JOY_NONE ) /* Left                        69  e9 */\
	PORT_BITX( 0x0200, IP_ACTIVE_HIGH, IPT_KEYBOARD,	"(MF2);ursor Right",	KEYCODE_RIGHT,      IP_JOY_NONE ) /* Right                       6a  ea */\
	PORT_BITX( 0x0400, IP_ACTIVE_HIGH, IPT_KEYBOARD,	"(MF2);nd",				KEYCODE_END,        IP_JOY_NONE ) /* End                         6b  eb */\
	PORT_BITX( 0x0800, IP_ACTIVE_HIGH, IPT_KEYBOARD,	"(MF2);ursor Down",		KEYCODE_DOWN,       IP_JOY_NONE ) /* Down                        6c  ec */\
	PORT_BITX( 0x1000, IP_ACTIVE_HIGH, IPT_KEYBOARD,	"(MF2);age Down",		KEYCODE_PGDN,       IP_JOY_NONE ) /* Page Down                   6d  ed */\
	PORT_BITX( 0x2000, IP_ACTIVE_HIGH, IPT_KEYBOARD,	"(MF2);nsert",			KEYCODE_INSERT,     IP_JOY_NONE ) /* Insert                      6e  ee */\
	PORT_BITX( 0x4000, IP_ACTIVE_HIGH, IPT_KEYBOARD,	"(MF2);elete",			KEYCODE_DEL,        IP_JOY_NONE ) /* Delete                      6f  ef */\
	PORT_BITX( 0x8000, IP_ACTIVE_HIGH, IPT_KEYBOARD,	"(MF2);ause",			KEYCODE_PAUSE,      IP_JOY_NONE ) /* Pause                       65  e5 */\
	PORT_START(); 	/* IN11 */\
