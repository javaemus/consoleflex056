...
public class vc4000
{
	...
	static void vc4000_init_colors (UBytePtr sys_palette,
	...
	static public static InitMachinePtr vc4000_machine_init = new InitMachinePtr() { public void handler() 
	{
	} };
	
	static MachineDriver machine_driver_vc4000 = new MachineDriver
	(
	...
	//			4430000/3,
		...
		sizeof (vc4000_palette) / sizeof (vc4000_palette[null]) ,
		sizeof (vc4000_colortable) / sizeof(vc4000_colortable[null][null]),
	...
	public static InitDriverPtr init_vc4000 = new InitDriverPtr() { public void handler() 
	{
		int i;
