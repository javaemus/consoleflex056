...
public class bbc
{
	...
	******************************************************************************/
	...
	static void init_palette_bbc(UBytePtr sys_palette, unsigned short *sys_colortable,const UBytePtr color_prom)
	{
	...
	static MachineDriver machine_driver_bbca = new MachineDriver
	(
	...
	static MachineDriver machine_driver_bbcb = new MachineDriver
	(
		/* basic machine hardware */
		new MachineCPU[] {
			new MachineCPU(
