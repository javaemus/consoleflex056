...
public class ssystem3
{
	...
	static DACinterface ssystem3_dac = new DACinterface( 1, new int[] {80}); // silence is golden
	
	static MachineDriver machine_driver_ssystem3 = new MachineDriver
	(
		...
		new MachineCPU[] {
			new MachineCPU(
				CPU_M6502,
				1000000,
				ssystem3_readmem, ssystem3_writemem,null,null,
		...
		sizeof (ssystem3_palette) / sizeof (ssystem3_palette[null]) + 32768,
		sizeof (ssystem3_colortable) / sizeof(ssystem3_colortable[null][null]),
		...
		0,0,0,0,
		new MachineSound[] {
			new MachineSound( SOUND_DAC, ssystem3_dac )
	    }
	);
	...
	public static InitDriverPtr init_ssystem3 = new InitDriverPtr() { public void handler() 
	{
		via_config(0,&config);
	} };
	...
	static public static InitMachinePtr ssystem3_machine_init = new InitMachinePtr() { public void handler() 
	{
		via_reset();
	} };
