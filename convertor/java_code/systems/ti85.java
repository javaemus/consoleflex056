...
public class ti85
{
	...
	static MachineDriver machine_driver_ti81 = new MachineDriver
	(
		...
		440,					/* screen width */
		330,					/* screen height */
		new rectangle(0, 440-1, 0, 330-1),			/* visible_area */
	...
	static MachineDriver machine_driver_ti85 = new MachineDriver
	(
		/* basic machine hardware */
		new MachineCPU[] {
			new MachineCPU(
	...
	static MachineDriver machine_driver_ti86 = new MachineDriver
	(
		/* basic machine hardware */
		new MachineCPU[] {
			new MachineCPU(
