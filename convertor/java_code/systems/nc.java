...
public class nc
{
	...
	*/
	...
	/* internal ram */
	UBytePtr nc_memory = NULL;
	/* card ram */
	UBytePtr nc_card_ram = NULL;
	...
	static void dummy_timer_callback(int dummy)
	{
		...
		if ((changed_bits & 0x01) != 0)
		{
	        if ((inputport_10_state & 0x01) != 0)
	        {
	...
	READ_HANDLER(nc100_card_battery_status_r)
	{
		...
		if ((printer_handshake & CENTRONICS_ACKNOWLEDGE) != 0)
		{
			nc_card_battery_status |=(1<<0);
		}
	...
	*/
	...
	(
		...
		new rectangle(0, (640/*NC_SCREEN_WIDTH*/ - 1), 0, (480/*NC_SCREEN_HEIGHT*/ - 1)),        /* rectangle: visible_area */
		null,							   /* graphics
											* decode info */
	...
	static MachineDriver machine_driver_nc200 = new MachineDriver
	(
		/* basic machine hardware */
		new MachineCPU[] {
			/* MachineCPU */
		...
		new rectangle(0, (NC200_SCREEN_WIDTH - 1), 0, (NC200_SCREEN_HEIGHT - 1)),        /* rectangle: visible_area */
		null,								   /* graphics
											* decode info */
