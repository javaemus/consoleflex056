...
public class apf
{
	...
	*/
	...
	extern UBytePtr apf_video_ram;
	
	void apf_common_init(void)
	{
		UBytePtr rom_ptr = memory_region(REGION_CPU1) + 0x010000;
	...
	public static InitMachinePtr apf_imagination_init_machine = new InitMachinePtr() { public void handler() 
	{
	...
	public static InitMachinePtr apf_m1000_init_machine = new InitMachinePtr() { public void handler() 
	{
		apf_common_init();
	} };
	...
	static MachineDriver machine_driver_apf_imagination = new MachineDriver
	(
	...
	static MachineDriver machine_driver_apf_m1000 = new MachineDriver
	(
		/* basic machine hardware */
		new MachineCPU[] {
			new MachineCPU(
