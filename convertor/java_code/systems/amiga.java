...
public class amiga
{
	...
	{
		new MemoryReadAddress( 0x000000, 0x07ffff, MRA_RAM ),			/* Chip Ram - 1Mb / 512k */
		new MemoryReadAddress( 0xbfd000, 0xbfefff, amiga_cia_r ),		/* 8510's CIA A and CIA B */
	//	new MemoryReadAddress( 0xc00000, 0xd7ffff, MRA_BANK1 ),			/* Internal Expansion Ram - 1.5 Mb */
		new MemoryReadAddress( 0xdbf000, 0xdfffff, amiga_custom_r ),		/* Custom Chips */
		new MemoryReadAddress( 0xf00000, 0xffffff, MRA_BANK2 ),			/* System ROM - mirror */
		new MemoryReadAddress( -1 )	/* end of table */
	};
	
	static MemoryWriteAddress writemem[] =
	{
		new MemoryWriteAddress( 0x000000, 0x07ffff, MWA_RAM ),			/* Chip Ram - 1Mb / 512k */
		new MemoryWriteAddress( 0xbfd000, 0xbfefff, amiga_cia_w ),		/* 8510's CIA A and CIA B */
	//	new MemoryWriteAddress( 0xc00000, 0xd7ffff, MWA_BANK1 ),			/* Internal Expansion Ram - 1.5 Mb */
		new MemoryWriteAddress( 0xdbf000, 0xdfffff, amiga_custom_w ),		/* Custom Chips */
		new MemoryWriteAddress( 0xf00000, 0xffffff, MWA_ROM ),			/* System ROM */
	...
	***************************************************************************/
	...
	static MachineDriver machine_driver_ntsc = new MachineDriver
	(
