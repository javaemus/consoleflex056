...
public class avigo
{
	...
	*/
	...
	static void avigo_refresh_memory(void)
	{
	        ...
	        addr = (UBytePtr )amd_flash_get_base(avigo_flash_at_0x4000);
	        ...
	        switch (avigo_ram_bank_h)
	        {
	               ...
	               case 0x06:
	                ...
	                case 0x03:
	                {
	                        ...
	                        addr = (UBytePtr )amd_flash_get_base(avigo_flash_at_0x8000);
	...
	public static InitMachinePtr avigo_init_machine = new InitMachinePtr() { public void handler() 
	{
		...
		addr = (UBytePtr )amd_flash_get_base(0);
		cpu_setbank(1, addr);
		cpu_setbank(5, addr);
	...
	(
		...
		/* video hardware */
	        640, /* screen width */
	        480,  /* screen height */
	        new rectangle(0, (640 - 1), 0, (480 - 1)),        /* rectangle: visible_area */
