...
public class pc8801
{
	...
	public static ReadHandlerPtr pc8801_unknown_in  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr pc8801_unknown_out = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static InterruptPtr pc8801fd_interrupt = new InterruptPtr() { public int handler() 
	{
	...
	(
	        ...
	        new ReadHandlerPtr[] { opn_dummy_input },
	        new ReadHandlerPtr[] { opn_dummy_input },
	        new WriteHandlerPtr[] { 0 },
	        new WriteHandlerPtr[] { 0 },
		new WriteYmHandlerPtr[] { pc88sr_sound_interupt }
	);
	
	static MachineDriver machine_driver_pc88srl = new MachineDriver
	(
		...
		/* video hardware */
		640, 200, new rectangle(0, 640-1, 0, 200-1),
		gfxdecodeinfo,
	        18,
	        32,
	        pc8801_init_palette,
	...
	static MachineDriver machine_driver_pc88srh = new MachineDriver
	(
		/* basic machine hardware */
		new MachineCPU[] {
			new MachineCPU(
		...
		/* video hardware */
		640, 400, new rectangle(0, 640-1, 0, 400-1),
		gfxdecodeinfo,
	        18,
	        32,
	        pc8801_init_palette,
