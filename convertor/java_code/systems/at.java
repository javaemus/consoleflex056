...
public class at
{
	...
	*/
	...
	static DACinterface dac_interface = new DACinterface( 1, new int[] { 50 });
	...
	static MachineDriver machine_driver_ps2m30286 = new MachineDriver
	(
	    /* basic machine hardware */
	    new MachineCPU[] {
	        new MachineCPU(
	...
	#ifdef HAS_I386
	static MachineDriver machine_driver_at386 = new MachineDriver
	(
	    /* basic machine hardware */
	    new MachineCPU[] {
	        new MachineCPU(
