...
public class kc
{
	...
	(
		...
		new rectangle(0, (KC85_SCREEN_WIDTH - 1), 0, (KC85_SCREEN_HEIGHT - 1)),	/* rectangle: visible_area */
	...
	static MachineDriver machine_driver_kc85_4d = new MachineDriver
	(
			/* basic machine hardware */
		new MachineCPU[] {
				/* MachineCPU */
	...
	static MachineDriver machine_driver_kc85_3 = new MachineDriver
	(
			/* basic machine hardware */
		new MachineCPU[] {
				/* MachineCPU */
