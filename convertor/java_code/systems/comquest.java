...
public class comquest
{
	...
	*/
	...
	static void comquest_init_colors (UBytePtr sys_palette,
	...
	static public static InitMachinePtr comquest_machine_init = new InitMachinePtr() { public void handler() 
	{
	...
	static MachineDriver machine_driver_comquest = new MachineDriver
	(
	...
	*/
		...
		// 16 out of 4096
		sizeof (comquest_palette) / sizeof (comquest_palette[null]) ,
		sizeof (comquest_colortable) / sizeof(comquest_colortable[null][null]),
	...
	public static InitDriverPtr init_comquest = new InitDriverPtr() { public void handler() 
	{
	//	int i;
