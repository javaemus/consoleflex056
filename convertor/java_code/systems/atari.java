...
public class atari
{
	...
	******************************************************************************/
	...
	static void atari_init_palette(UBytePtr sys_palette, unsigned short *sys_colortable,const UBytePtr color_prom)
	{
	...
	static POKEYinterface pokey_interface = new POKEYinterface(
		...
		FREQ_17_EXACT,
	    new int[] { 100 },
		new ReadHandlerPtr[] { input_port_8_r, },
		new ReadHandlerPtr[] { input_port_9_r, },
		new ReadHandlerPtr[] { input_port_10_r, },
		new ReadHandlerPtr[] { input_port_11_r, },
		new ReadHandlerPtr[] { input_port_12_r, },
		new ReadHandlerPtr[] { input_port_13_r, },
		new ReadHandlerPtr[] { input_port_14_r, },
		new ReadHandlerPtr[] { input_port_15_r, },
	...
	static MachineDriver machine_driver_a400 = new MachineDriver
	(
		...
		new MachineCPU[] {
			new MachineCPU(
				CPU_M6510,
				FREQ_17_EXACT,
				readmem_a400,writemem_a400,null,null,
				a400_interrupt, TOTAL_LINES_60HZ	/* every scanline */
	        )
		},
		/* frames per second, VBL handled by atari_interrupt */
		FRAME_RATE_60HZ, null,
	    1,
		a400_init_machine,
		a800_close_floppy,
	
		/* video hardware */
		HWIDTH*8, TOTAL_LINES_60HZ, new rectangle( MIN_X, MAX_X, MIN_Y, MAX_Y ),
	    null,
	...
	static MachineDriver machine_driver_a400pal = new MachineDriver
	(
		/* basic machine hardware */
		new MachineCPU[] {
			new MachineCPU(
		...
		/* frames per second, VBL handled by atari_interrupt */
		FRAME_RATE_50HZ, null,
	    1,
		a400_init_machine,
		a800_close_floppy,
	
		/* video hardware */
		HWIDTH*8, TOTAL_LINES_50HZ, new rectangle( MIN_X, MAX_X, MIN_Y, MAX_Y ),
	    null,
		sizeof(palette) / sizeof(palette[null]) / 3,
		sizeof(colortable) / sizeof(colortable[null]),
		atari_init_palette,
	...
	static MachineDriver machine_driver_a800 = new MachineDriver
	(
		/* basic machine hardware */
		new MachineCPU[] {
			new MachineCPU(
				CPU_M6510,
				FREQ_17_EXACT,
				readmem_a800,writemem_a800,null,null,
	...
	static MachineDriver machine_driver_a800pal = new MachineDriver
	(
		/* basic machine hardware */
		new MachineCPU[] {
			new MachineCPU(
	...
	static MachineDriver machine_driver_a800xl = new MachineDriver
	(
		/* basic machine hardware */
		new MachineCPU[] {
			new MachineCPU(
				CPU_M6510,
				FREQ_17_EXACT,
	            readmem_a800xl,writemem_a800xl,null,null,
	...
	static MachineDriver machine_driver_a5200 = new MachineDriver
	(
		/* basic machine hardware */
		new MachineCPU[] {
			new MachineCPU(
				CPU_M6510,
				FREQ_17_EXACT,
	            readmem_5200,writemem_5200,null,null,
