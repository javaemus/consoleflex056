...
public class sord
{
	...
	static public static InitMachinePtr sord_m5_fd5_init_machine = new InitMachinePtr() { public void handler() 
	{
	...
	public static ReadHandlerPtr sord_keyboard_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	*/
	...
	public static InterruptPtr sord_m5_interrupt = new InterruptPtr() { public int handler() 
	{
		TMS9928A_interrupt();
	...
	public static InitMachinePtr sord_m5_init_machine = new InitMachinePtr() { public void handler() 
	{
	...
	static MachineDriver machine_driver_sord_m5 = new MachineDriver
	(
	...
	static MachineDriver machine_driver_sord_m5_fd5 = new MachineDriver
	(
		/* basic machine hardware */
		new MachineCPU[] {
			/* MachineCPU */
