...
public class pc1500
{
	...
	static public static InitMachinePtr pc1500_machine_init = new InitMachinePtr() { public void handler() 
	{
	} };
	...
	static MachineDriver machine_driver_pc1500 = new MachineDriver
	(
		...
		new MachineCPU[] {
			new MachineCPU(
				...
				null,null, /* port handler */
				pc1500_frame_int, /* vertical retrace interrupt */
				1, /* 1 vertical interrupt in 1/60 second */
				null, /* second interrupt, normally for raster line line interrupts */
				0,
	...
	static MachineDriver machine_driver_trs80pc2 = new MachineDriver
	(
		/* basic machine hardware */
		new MachineCPU[] {
			new MachineCPU(
	...
	static MachineDriver machine_driver_pc1500a = new MachineDriver
	(
		/* basic machine hardware */
		new MachineCPU[] {
			new MachineCPU(
	...
	*/
	...
	/* only called once */
	public static InitDriverPtr init_pc1500 = new InitDriverPtr() { public void handler() 
	{
		int i;
	...
	public static InitDriverPtr init_pc1500a = new InitDriverPtr() { public void handler() 
	{
		int i;
		UINT8 *gfx=memory_region(REGION_GFX1);
		for (i=0; i<256; i++) gfx[i]=i;
