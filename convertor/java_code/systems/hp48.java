...
public class hp48
{
	...
	static MachineDriver machine_driver_hp48s = new MachineDriver
	(
		...
		sizeof (hp48_palette) / sizeof (hp48_palette[null]) ,
		sizeof (hp48_colortable) / sizeof(hp48_colortable[null][null]),
	...
	static MachineDriver machine_driver_hp48g = new MachineDriver
	(
		/* basic machine hardware */
		new MachineCPU[] {
			new MachineCPU(
