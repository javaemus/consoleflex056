...
public class galaxy
{
	...
	static void galaxy_init_palette (UBytePtr sys_palette, unsigned short *sys_colortable, const UBytePtr color_prom)
	new GfxDecodeInfo(
	...
	static MachineDriver machine_driver_galaxy = new MachineDriver
	(
		...
		32 * 8,					/* screen width */
		16 * 13,				/* screen height */
		new rectangle(0, 32 * 8 - 1, 0, 16 * 13 - 1),	/* visible_area */
