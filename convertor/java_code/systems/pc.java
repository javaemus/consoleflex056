...
public class pc
{
	...
	*/
	...
	static YM3812interface ym3812_interface = new YM3812interface(
		...
		new WriteYmHandlerPtr[] {pc_irqhandler}
	);
	#endif
	...
	//    sizeof(mda_palette) / sizeof(mda_palette[null]),
	    sizeof(cga_palette) / sizeof(cga_palette[null]),
	...
	#endif
	#if defined(GAMEBLASTER)
			new MachineSound( SOUND_SAA1099, cms_interface ),
	#endif
	    }
	);
	...
	static MachineDriver machine_driver_europc = new MachineDriver
	(
	    /* basic machine hardware */
	    new MachineCPU[] {
	        new MachineCPU(
		...
		sizeof(cga_palette) / sizeof(cga_palette[null]),
		(sizeof(cga_colortable)+sizeof(mda_colortable) )/sizeof(cga_colortable[null]),
	...
	(
		...
		new rectangle( 0,80*8-1, 0,25*8-1),					/* visible_area */
		CGA_gfxdecodeinfo,							/* graphics decode info */
		sizeof(cga_palette) / sizeof(cga_palette[null]),
		sizeof(cga_colortable) / sizeof(cga_colortable[null]),
		pc_cga_init_palette,							/* init palette */
	...
	static MachineDriver machine_driver_pc200 = new MachineDriver
	(
	    /* basic machine hardware */
	    new MachineCPU[] {
	        new MachineCPU(
	...
	(
		...
		sizeof(ega_palette) / sizeof(ega_palette[null]),
		0x100*2, //sizeof(vga_colortable) / sizeof(vga_colortable[null]),
	...
	(
		...
		vga_gfxdecodeinfo,							/* graphics decode info */
		sizeof(vga_palette) / sizeof(vga_palette[null]),
		0x100*2, //sizeof(vga_colortable) / sizeof(vga_colortable[null]),
	...
	(
		...
		new rectangle( 0,80*8-1, 0,25*9-1),					/* visible_area */
		t1t_gfxdecodeinfo,							/* graphics decode info */
		sizeof(cga_palette) / sizeof(cga_palette[null]),
		sizeof(pcjr_colortable) / sizeof(pcjr_colortable[null]),
