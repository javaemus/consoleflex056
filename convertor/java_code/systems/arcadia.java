...
public class arcadia
{
	...
	static void arcadia_init_colors (UBytePtr sys_palette,
	...
	static public static InitMachinePtr arcadia_machine_init = new InitMachinePtr() { public void handler() 
	{
	} };
	
	static MachineDriver machine_driver_arcadia = new MachineDriver
	(
		...
		sizeof (arcadia_palette) / sizeof (arcadia_palette[null]) ,
		sizeof (arcadia_colortable) / sizeof(arcadia_colortable[null][null]),
	...
	public static InitDriverPtr init_arcadia = new InitDriverPtr() { public void handler() 
	{
		int i;
