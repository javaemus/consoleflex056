...
public class kaypro
{
	...
	{
		new MemoryWriteAddress( 0x0000, 0xffff, MWA_RAM ),
		new MemoryWriteAddress( -1 )
	};
	
	static IOReadPort readport[] =
	{
		new IOReadPort( BIOS_CONST,  BIOS_CONST,	kaypro_const_r ),
		new IOReadPort( BIOS_CONIN,  BIOS_CONIN,  kaypro_conin_r ),
		new IOReadPort( BIOS_CONOUT, BIOS_CONOUT, kaypro_conout_r ),
		new IOReadPort( BIOS_CMD,    BIOS_CMD,    cpm_bios_command_r ),
		new IOReadPort( -1 )
	};
	
	static IOWritePort writeport[] =
	{
		new IOWritePort( BIOS_CONST,  BIOS_CONST,	kaypro_const_w ),
		new IOWritePort( BIOS_CONIN,  BIOS_CONIN,  kaypro_conin_w ),
		new IOWritePort( BIOS_CONOUT, BIOS_CONOUT, kaypro_conout_w ),
		new IOWritePort( BIOS_CMD,    BIOS_CMD,    cpm_bios_command_w ),
		new IOWritePort( -1 )
	};
	...
	static void kaypro_init_palette(UBytePtr sys_palette, unsigned short *sys_colortable,const UBytePtr color_prom)
	{
		memcpy(sys_palette,palette,sizeof(palette));
		memcpy(sys_colortable,colortable,sizeof(colortable));
	}
	
	static MachineDriver machine_driver_kaypro = new MachineDriver
	(
		...
		new rectangle( 0*KAYPRO_FONT_W, 80*KAYPRO_FONT_W-1,
