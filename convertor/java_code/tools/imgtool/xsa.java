...
public class xsa
{
	...
	/****************************************************************/
	static static void charout(UINT8);      /* put a character in the output stream */
	static unsigned rdstrlen( void ); /* read string length                   */
	static unsigned rdstrpos( void ); /* read string pos                      */
	static static UINT8 charin( void );       /* read a char                          */
