...
public class kc
{
	...
	void kc85_init_palette(UBytePtr sys_palette, unsigned short *sys_colortable, const UBytePtr color_prom)
	{
	...
	static void kc85_draw_8_pixels(struct mame_bitmap *bitmap,int x,int y, unsigned char colour_byte, unsigned char gfx_byte)
	{
		...
		if ((colour_byte & kc85_blink_state) != 0)
		{
	...
	*/
	...
	struct video_update_state
	{
		...
		void (*pixel_grab_callback)(struct grab_info *,int x,int y, UBytePtr colour_ptr, UBytePtr pixel_ptr);
		/* current coords */
		int x,y;
		/* render coordinates */
	...
	static void kc85_common_process_frame(struct mame_bitmap *bitmap, void (*pixel_grab_callback)(struct grab_info *,int x,int y,UBytePtr , UBytePtr ),struct grab_info *grab_data)
	{
	...
	***************************************************************************/
	...
	static public static VhEofCallbackPtr kc85_common_vh_eof_callback = new VhEofCallbackPtr() { public void handler() 
	{
			EVENT_LIST_ITEM *pItem;
			int NumItems;
	...
	static public static VhStopPtr kc85_common_vh_stop = new VhStopPtr() { public void handler() 
	{
		EventList_Finish();
	} };
	
	
	static UBytePtr kc85_4_display_video_ram;
	
	static UBytePtr kc85_4_video_ram;
	...
	UBytePtr kc85_4_get_video_ram_base(int bank, int colour)
	{
	    /* base address: screen 0 pixel data */
		UBytePtr addr = kc85_4_video_ram;
	...
	static void kc85_4_pixel_grab_callback(struct grab_info *grab_data,int x,int y, UBytePtr colour, UBytePtr gfx)
	{
		int offset;
	...
	***************************************************************************/
	...
	public static VhStartPtr kc85_3_vh_start = new VhStartPtr() { public int handler() 
	{
		kc85_common_vh_start();
	...
	public static VhStopPtr kc85_3_vh_stop = new VhStopPtr() { public void handler()  
	{
		kc85_common_vh_stop();
	
	} };
	
	extern UBytePtr kc85_ram;
	
	
	static void kc85_3_pixel_grab_callback(struct grab_info *grab_data,int x,int y, UBytePtr colour, UBytePtr gfx)
	{
	...
	***************************************************************************/
	void kc85_3_vh_screenrefresh(struct mame_bitmap *bitmap, int full_refresh)
	{
		...
		/* colour ram takes up 0x02800 bytes */
		   UBytePtr pixel_ram = kc85_ram+0x08000;	
	    UBytePtr colour_ram = pixel_ram + 0x02800;
