...
public class pc1500
{
	...
	void pc1500_init_colors (UBytePtr sys_palette,
	...
	public static VhStartPtr pc1500_vh_start = new VhStartPtr() { public int handler() 
	{
	#if 1
	...
	public static VhStopPtr pc1500_vh_stop = new VhStopPtr() { public void handler() 
	{
	    if (backdrop != 0)
