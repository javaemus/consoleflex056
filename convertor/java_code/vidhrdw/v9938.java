...
public class v9938
{
	...
	static static void v9938_cpu_to_vdp (UINT8 V);
	static UINT8 v9938_command_unit_w (UINT8 Op);
	static UINT8 v9938_vdp_to_cpu (void);
	static static void v9938_refresh_line (struct mame_bitmap *bmp, int line);
	...
	*/
	...
	public static VhConvertColorPromPtr v9938_init_palette = new VhConvertColorPromPtr() { public void handler(char []palette, char []colortable, UBytePtr color_prom) 
		{
		int	i,red;
	...
	*/
	...
	public static VhConvertColorPromPtr v9958_init_palette = new VhConvertColorPromPtr() { public void handler(char []palette, char []colortable, UBytePtr color_prom) 
	    {
	...
	*/
	...
	public static InterruptPtr v9938_interrupt = new InterruptPtr() { public int handler() 
		{
		UINT8 col[256];
	...
	***************************************************************************/
	...
	INLINE void VDPpsetlowlevel(UINT8 *P, UINT8 CL, UINT8 M, UINT8 OP)
	{
	  switch (OP)
	  {
	    ...
	    case 8: if (CL != 0) *P = (*P & M) | CL; break;
	    case 9: if (CL != 0) *P = *P & (CL | M); break;
	    case 10: if (CL != 0) *P |= CL; break;
	    case 11:  if (CL != 0) *P ^= CL; break;
	    case 12:  if (CL != 0) *P = (*P & M) | ~(CL|M); break;
	  }
	}
