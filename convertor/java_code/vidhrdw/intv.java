...
public class intv
{
	...
	public static VhStartPtr intv_vh_start = new VhStartPtr() { public int handler() 
	{
		int i;
	...
	public static VhStopPtr intv_vh_stop = new VhStopPtr() { public void handler() 
	{
		...
		else
		{
			...
			for(row = 0; row < 12; row++)
			{
				for(col = 0; col < 20; col++)
				{
					...
					if ((value & 0x0800) != 0) /* read for GRAM */
					{
						//if (intv_gramdirty[code] == 1)
						{
							decodechar(Machine.gfx[1],
	...
	public static VhStartPtr intvkbd_vh_start = new VhStartPtr() { public int handler() 
	{
		videoram_size[0] = 0x0800;
	...
	public static VhStopPtr intvkbd_vh_stop = new VhStopPtr() { public void handler() 
	{
		intv_vh_stop();
		free(videoram);
		generic_vh_stop();
