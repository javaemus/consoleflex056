...
public class ssystem3
{
	...
	public static VhStartPtr ssystem3_vh_start = new VhStartPtr() { public int handler() 
	{
	...
	public static VhStopPtr ssystem3_vh_stop = new VhStopPtr() { public void handler() 
	{
		generic_vh_stop();
	} };
