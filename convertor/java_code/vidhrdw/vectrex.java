...
public class vectrex
{
	...
	public static WriteHandlerPtr v_via_pb_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		if (!(data & 0x80))
		{
			/* RAMP is active */
	...
	public static WriteHandlerPtr v_via_pa_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		double time_;
	...
	public static WriteHandlerPtr v_via_ca2_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	*****************************************************************/
	...
	extern int png_read_artwork(const char *file_name, struct mame_bitmap **bitmap, UBytePtr *palette, int *num_palette, UBytePtr *trans, int *num_trans);
	...
	void raaspec_init_artwork (UBytePtr palette, unsigned short *colortable,const UBytePtr color_prom)
	{
