...
public class z88
{
	...
	***************************************************************************/
	...
	static void z88_vh_render_8x8(struct mame_bitmap *bitmap, int x, int y, UBytePtr pData)
	{
	        int h,b;
	        int pen0, pen1;
	...
	static void z88_vh_render_6x8(struct mame_bitmap *bitmap, int x, int y, UBytePtr pData)
	{
		int h,b;
		int pen0, pen1;
	...
	***************************************************************************/
	...
	{
	    int x,y;
	    UBytePtr ptr = z88_convert_address(blink.sbf);
		UBytePtr stored_ptr = ptr;
		...
		for (y=0; y<(Z88_SCREEN_HEIGHT>>3); y++)
		{
			...
			for (x=0; x<(Z88_SCREEN_WIDTH>>3); x++)
			{
				...
				/* hi-res? */
				if ((byte1 & Z88_SCR_HW_HRS) != 0)
				{
					if ((byte1 & Z88_SCR_HW_REV) != 0)
					{
