...
public class aim65
{
	...
	public static VhConvertColorPromPtr aim65_init_colors = new VhConvertColorPromPtr() { public void handler(char []palette, char []colortable, UBytePtr color_prom) 
	{
		memcpy (palette, aim65_palette, sizeof (aim65_palette));
	} };
	
	public static VhStartPtr aim65_vh_start = new VhStartPtr() { public int handler() 
	{
	...
	public static VhStopPtr aim65_vh_stop = new VhStopPtr() { public void handler() 
	{
	    videoram = NULL;
	    generic_vh_stop ();
	} };
