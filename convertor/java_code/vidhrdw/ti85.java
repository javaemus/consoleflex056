...
public class ti85
{
	...
	void ti85_init_palette (UBytePtr sys_palette, unsigned short *sys_colortable, const UBytePtr color_prom)
	{
		char *backdrop_name;
	...
	public static VhStartPtr ti85_vh_start = new VhStartPtr() { public int handler() 
	{
		return 0;
	} };
	
	public static VhStopPtr ti85_vh_stop = new VhStopPtr() { public void handler() 
	{
		free (ti85_frames);
	} };
