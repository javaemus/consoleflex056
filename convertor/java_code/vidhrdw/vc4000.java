...
public class vc4000
{
	...
	public static VhStartPtr vc4000_vh_start = new VhStartPtr() { public int handler() 
	{
	    int i;
	    for (i=0;i<0x20; i++) {
	...
	public static VhStopPtr vc4000_vh_stop = new VhStopPtr() { public void handler() 
	{
	} };
