        ...
        for (cpunum = 0; cpunum < cpu_gettotalcpu(); cpunum++) {
            ...
            if (mra_obj != null) {
                if (mra_obj instanceof IO_ReadPort[]) {
                    ...
                    System.out.println(Machine.drv);
                    System.out.println(Machine.drv.cpu[cpunum]);
                    System.out.println(Machine.drv.cpu[cpunum].port_read);
                    System.out.println(Machine.drv.cpu[cpunum].port_write);
