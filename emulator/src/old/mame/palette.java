...
import static WIP.arcadeflex.video.osd_allocate_colors;
import static WIP.arcadeflex.video.osd_modify_pen;
...
public class palette {
 ...
 /* use shrinked_pens[] directly */
    ...
    public static void palette_set_color(int color, int red, int green, int blue) {
        if ((Machine.drv.video_attributes & VIDEO_MODIFIES_PALETTE) == 0) {
