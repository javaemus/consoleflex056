...
public class cpuintrfH {
    ...
    public static final int MAX_IRQ_LINES = 8;
    /* maximum number of IRQ lines per CPU */

    public static final int CLEAR_LINE = 0;
    /* clear (a fired, held or pulsed) line */
    public static final int ASSERT_LINE = 1;
    /* assert an interrupt immediately */
    public static final int HOLD_LINE = 2;
    /* hold interrupt line until enable is true */
    public static final int PULSE_LINE = 3;
    /* pulse interrupt line for one instruction */

    public static final int MAX_REGS = 128;
    /* maximum number of register of any CPU */
 ...
 /* Values passed to the cpu_info function of a core to retrieve information */
    ...
    public static final int CPU_IS_LE = 0;
    /* emulated CPU is little endian */
    public static final int CPU_IS_BE = 1;
    /* emulated CPU is big endian */
 ...
 /*
    ...
    public static abstract class cpu_interface {
        ...
        public abstract Object init_context(); //not in mame_old , used specific for arcadeflex_old

        public abstract Object get_context(); //different from mame_old returns reg object and not size since java doesn't support references
 ...
 /* This can now be handled with a generic function */
    ...
    public static final int Z80_MAXDAISY = 4;
    /* maximum of daisy chan device */

    public static final int Z80_INT_REQ = 0x01;
    /* interrupt request mask       */
    public static final int Z80_INT_IEO = 0x02;
    /* interrupt disable mask(IEO)  */
